  ...
  return (
    <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex h-16 w-full max-w-7xl items-center gap-3 px-4">
        <Link href="/" className="shrink-0 text-2xl font-black tracking-tight text-slate-900">
        ...
        <div className="hidden flex-1 md:block">
          <input
            type="text"
            placeholder="Search for items, sellers, and categories"
            className="h-10 w-full rounded-full border border-slate-200 bg-slate-50 px-4 text-sm text-slate-700 outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-200"
          />
        </div>
